...
| 2 | `_risk()` | src/metabokg/analyze.py | **1** | 🟢 LOW |
| 3 | `_parse_factor_args()` | src/metabokg/cli/_utils.py | **1** | 🟢 LOW |
| 4 | `register_tools()` | src/metabokg/mcp_tools.py | **1** | 🟢 LOW |
| 5 | `render_fba_result()` | src/metabokg/simulate.py | **1** | 🟢 LOW |
| 6 | `render_whatif_result()` | src/metabokg/simulate.py | **1** | 🟢 LOW |
...
| 11 | `whatif()` | src/metabokg/cli/cmd_simulate.py | **0** | 🟢 LOW |
...
| 15 | `__enter__()` | src/metabokg/orchestrator.py | **0** | 🟢 LOW |
...
|--------|-----------|---------|----------|----------|----------|
| `src/metabokg/cli/cmd_build.py` | 0 | 0 | 1 | 7 | 0.80 |
| `src/metabokg/cli/__init__.py` | 0 | 0 | 0 | 9 | 0.90 |
| `src/metabokg/cli/_utils.py` | 0 | 0 | 0 | 8 | 0.90 |
| `src/metabokg/cli/main.py` | 0 | 0 | 0 | 6 | 0.89 |
...
| `__str__()` | src/metabokg/enrich.py | 5 |
| `__repr__()` | src/metabokg/orchestrator.py | 5 |
...
| `__exit__()` | src/metabokg/orchestrator.py | 1 |
| `supported_extensions()` | src/metabokg/parsers/biopax.py | 1 |
| `supported_extensions()` | src/metabokg/parsers/kgml.py | 1 |
| `supported_extensions()` | src/metabokg/parsers/sbml.py | 1 |
