...
The \texttt{metabokg-analyze} command runs a seven-phase analysis and produces
...
$ metabokg-build --data ./pathways --wipe
\end{lstlisting}
...
tractable. Running \texttt{metabokg-build} without \texttt{--wipe} issues
...
re-run \texttt{metabokg-build} after updating source files. This design choice
