...
Registers:
  metabokg simulate fba     — Flux Balance Analysis
...
def fba(obj: dict, pathway: str | None, objective: str | None, minimize: bool) -> None:
    ...
    from metabokg.simulate import SimulationConfig, render_fba_result
    ...
    _write_output(text, obj["output"], "metabokg-simulate-fba")
...
def ode(
    ...
    from metabokg import MetaKG
    from metabokg.simulate import SimulationConfig, render_ode_result
    ...
    _write_output(text, obj["output"], "metabokg-simulate-ode")
...
def whatif(
    ...
    from metabokg import MetaKG
    from metabokg.simulate import SimulationConfig, WhatIfScenario, render_whatif_result
    ...
    _write_output(text, obj["output"], "metabokg-simulate-whatif")
