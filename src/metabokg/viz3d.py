...
def _build_qt_window(
    ...
    :param layout_nodes: Pre-converted :class:`~metabokg.layout3d.LayoutNode` list.
    :param layout_edges: Pre-converted :class:`~metabokg.layout3d.LayoutEdge` list.
    ...
    def _node_display_name(node: Any) -> str:
        ...
        :param node: :class:`~metabokg.layout3d.LayoutNode` instance.
...
def launch(
    ...
    try:
        ...
        from metabokg.layout3d import LayoutEdge, LayoutNode
        ...
        # ------------------------------------------------------------------
        from metabokg.layout3d import AlliumLayout, LayerCakeLayout, Layout3D
...
def _run_export(
    ...
    :param layout_nodes: Positioned :class:`~metabokg.layout3d.LayoutNode` list.
    :param layout_edges: :class:`~metabokg.layout3d.LayoutEdge` list.
