"""
metabokg.py — MetaKG: top-level orchestrator for the metabolic knowledge graph.
...
from metabokg.enrich import enrich as _enrich
from metabokg.graph import MetabolicGraph
from metabokg.index import MetaIndex
from metabokg.kinetics_fetch import seed_kinetics as _seed_kinetics
