---
mode: 'agent'
description: 'Generate a comprehensive metabolic pathway analysis report from the MetaboKG database.'
---
...
Analyzes the MetaboKG database and produces a polished report including:
