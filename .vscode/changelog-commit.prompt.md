---
mode: 'agent'
description: 'Analyze staged git changes, update CHANGELOG.md, and prepare a commit message file.'
---

# Changelog & Commit Workflow

Analyze staged git changes, update the CHANGELOG.md, and prepare a commit message. Execute the following steps in sequence:
